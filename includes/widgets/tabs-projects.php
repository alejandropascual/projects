...
add_action( 'widgets_init', array( 'aps_widget_tabs_projects', 'aps_register_widget' ) );


class aps_widget_tabs_projects extends WP_Widget
{
    ...
    {
        $widget_ops = array( 'description' => _x( 'Tabs projects', 'widget', LANGUAGE_THEME ) );
        parent::WP_Widget(false, _x('ELAP: Tabs projects', 'widget', LANGUAGE_THEME), $widget_ops);
    }
    ...
    function form( $instance )
    {
        ...
        //echo '<pre>'; print_r( $all_terms ); echo '</pre>';
        ...
        foreach($campos as $campo) {
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id($campo); ?>"><?php _ex('Taxonomy fot TAB '.$index++.':', 'widget', LANGUAGE_THEME); ?></label>
